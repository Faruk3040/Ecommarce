...
class ProductController extends Controller
{
    ...
    public function addToCart(Request $request){
        ...
        If(isset($cart) && $cart !=null){
            ...
            Cart::update($cart->rewId,['qty' =>$quantity, 'options' =>  ['size' => $size, 'image' => $image, 'total' => $total]]);
        }else{
            $total = ((int)$quantity * (int)$price);
    ...
    public function removeitem($rowId){
        Cart::remove($rowId);
        return redirect('/cart')->with('success', ' Product Successfully Remove!');
    }
    ...
    public function home(){
        ...
        return view('navigation.maincontent', compact('featured_products', 'latest_products'));
    }
